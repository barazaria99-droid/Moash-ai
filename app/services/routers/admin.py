...
# Strip "whatsapp:" prefix from wa_phone for display, e.g. "whatsapp:+972501234567" → "+972501234567"
templates.env.filters["strip_wa"]         = lambda s: (s or "").removeprefix("whatsapp:")
